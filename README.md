...
### Основной функционал
⚙️ регистрация и авторизация с разделением ролей
⚙️ создание заказов с указанием адреса и типа доставки
⚙️ автоматический расчет стоимости доставки
⚙️ прием и выполнение заказов курьерами
⚙️ построение оптимального маршрута на основе геоданных
⚙️ отслеживание статуса доставки в реальном времени
⚙️ генерация аналитики для администратора
⚙️ оповещение о сбоях и нештатных ситуациях
